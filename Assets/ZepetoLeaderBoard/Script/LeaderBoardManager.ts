...
export default class LeaderboardManager extends ZepetoScriptBehaviour {
    ...
    private Start(){
        if(this.leaderboardId == "") {
            console.warn("error!  leaderboardId is empty");
            const message = "See the docs <color=blue><a href=\"https://naverz-group.readme.io/studio-world/docs/leaderboard\">here</a></color> for more information.";
            console.warn(message);
            return;
        }
        
        // 한번이라도 게임에 접속하면 0 점을 send
        this.SendScore(0);
